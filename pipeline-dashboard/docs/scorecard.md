...
**Test counts grew from 936 unit / 197 integration (pre-R1) to <!-- AUTO:test-counts -->**1059 unit / 241 integration**<!-- /AUTO --> after R1-i landed.** The R1 round added approximately +89 unit + +29 integration = +118 tests, all green.
...
- Test counts: <!-- AUTO:test-counts -->**1059 unit / 241 integration**<!-- /AUTO --> + legacy + smoke, all green. _(line auto-derived by `npm run scorecard:sync`; do not hand-edit between markers.)_
