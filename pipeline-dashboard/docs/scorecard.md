...
- Test counts: <!-- AUTO:test-counts -->**1025 unit / 226 integration**<!-- /AUTO --> + legacy + smoke, all green. _(line auto-derived by `npm run scorecard:sync`; do not hand-edit between markers.)_
