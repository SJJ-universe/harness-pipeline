...
**Test counts grew from 936 unit / 197 integration (pre-R1) to <!-- AUTO:test-counts -->**1106 unit / 249 integration**<!-- /AUTO --> after R1-i landed.** The R1 round added approximately +89 unit + +29 integration = +118 tests, all green.
