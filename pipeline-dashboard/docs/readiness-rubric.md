...
The harness has strong unit + integration coverage (<!-- AUTO:test-counts -->**2356 unit / 454 integration**<!-- /AUTO -->) — but unit coverage tells you "the code does what it says". It does NOT tell you whether the system is OPERATIONALLY usable for the next wave. This rubric defines that operational view.
