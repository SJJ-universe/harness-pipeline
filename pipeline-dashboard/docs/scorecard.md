...
**Test counts grew from 936 unit / 197 integration (pre-R1) to <!-- AUTO:test-counts -->**3825 unit / 553 integration**<!-- /AUTO --> across R1-a through R1-k.** The R1 round added approximately +170 unit + +52 integration = +222 tests, all green.
...
- Test counts: <!-- AUTO:test-counts -->**3825 unit / 553 integration**<!-- /AUTO --> + legacy + smoke, all green. _(line auto-derived by `npm run scorecard:sync`; do not hand-edit between markers.)_
